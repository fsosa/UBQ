...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Locked_Nucleotide'
        db.create_table('beasties_app_locked_nucleotide', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('symbol', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beasties_app.Nucleotide'])),
            ('codon_position', self.gf('django.db.models.fields.IntegerField')()),
            ('nucleotide_position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('beasties_app', ['Locked_Nucleotide'])

        # Adding field 'Enemy.locked_nucleotide_1'
        db.add_column('beasties_app_enemy', 'locked_nucleotide_1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locked_one', null=True, to=orm['beasties_app.Locked_Nucleotide']), keep_default=False)

        # Adding field 'Enemy.locked_nucleotide_2'
        db.add_column('beasties_app_enemy', 'locked_nucleotide_2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locked_two', null=True, to=orm['beasties_app.Locked_Nucleotide']), keep_default=False)

        # Adding field 'Enemy.locked_nucleotide_3'
        db.add_column('beasties_app_enemy', 'locked_nucleotide_3', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locked_three', null=True, to=orm['beasties_app.Locked_Nucleotide']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Locked_Nucleotide'
        db.delete_table('beasties_app_locked_nucleotide')

        # Deleting field 'Enemy.locked_nucleotide_1'
        db.delete_column('beasties_app_enemy', 'locked_nucleotide_1_id')

        # Deleting field 'Enemy.locked_nucleotide_2'
        db.delete_column('beasties_app_enemy', 'locked_nucleotide_2_id')

        # Deleting field 'Enemy.locked_nucleotide_3'
        db.delete_column('beasties_app_enemy', 'locked_nucleotide_3_id')
