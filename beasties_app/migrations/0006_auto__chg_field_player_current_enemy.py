...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.current_enemy'
        db.alter_column('beasties_app_player', 'current_enemy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beasties_app.Enemy'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Player.current_enemy'
        db.alter_column('beasties_app_player', 'current_enemy_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['beasties_app.Enemy']))
