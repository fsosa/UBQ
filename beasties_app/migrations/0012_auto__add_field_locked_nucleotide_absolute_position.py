...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Locked_Nucleotide.absolute_position'
        db.add_column('beasties_app_locked_nucleotide', 'absolute_position', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Locked_Nucleotide.absolute_position'
        db.delete_column('beasties_app_locked_nucleotide', 'absolute_position')
