...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enemy.weakness_1'
        db.add_column('beasties_app_enemy', 'weakness_1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='weakness_one', null=True, to=orm['beasties_app.Weakness']), keep_default=False)

        # Adding field 'Enemy.weakness_2'
        db.add_column('beasties_app_enemy', 'weakness_2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='weakness_two', null=True, to=orm['beasties_app.Weakness']), keep_default=False)

        # Adding field 'Enemy.weakness_3'
        db.add_column('beasties_app_enemy', 'weakness_3', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='weakness_three', null=True, to=orm['beasties_app.Weakness']), keep_default=False)

        # Adding field 'Enemy.weakness_4'
        db.add_column('beasties_app_enemy', 'weakness_4', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='weakness_four', null=True, to=orm['beasties_app.Weakness']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('beasties_app_zombie', (
            ('hand_phenotype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['beasties_app.Phenotype'])),
            ('horn_phenotype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['beasties_app.Phenotype'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('mouth_phenotype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['beasties_app.Phenotype'])),
            ('won_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tail_phenotype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['beasties_app.Phenotype'])),
        ...
        # Deleting field 'Enemy.weakness_1'
        db.delete_column('beasties_app_enemy', 'weakness_1_id')

        # Deleting field 'Enemy.weakness_2'
        db.delete_column('beasties_app_enemy', 'weakness_2_id')

        # Deleting field 'Enemy.weakness_3'
        db.delete_column('beasties_app_enemy', 'weakness_3_id')

        # Deleting field 'Enemy.weakness_4'
        db.delete_column('beasties_app_enemy', 'weakness_4_id')
