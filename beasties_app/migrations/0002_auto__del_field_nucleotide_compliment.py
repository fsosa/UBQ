...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('beasties_app_nucleotide', 'compliment', self.gf('django.db.models.fields.related.ForeignKey')(default='A', to=orm['beasties_app.Nucleotide']), keep_default=False)
