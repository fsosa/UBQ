...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Amino_Acid_Name.symbol'
        db.add_column('beasties_app_amino_acid_name', 'symbol', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)

        # Deleting field 'Amino_Acid.symbol'
        db.delete_column('beasties_app_amino_acid', 'symbol')


    def backwards(self, orm):
        
        # Deleting field 'Amino_Acid_Name.symbol'
        db.delete_column('beasties_app_amino_acid_name', 'symbol')

        # Adding field 'Amino_Acid.symbol'
        db.add_column('beasties_app_amino_acid', 'symbol', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)
