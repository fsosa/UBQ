...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.defeated_enemies'
        db.add_column('userprofs_userprofile', 'defeated_enemies', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='[]', max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.defeated_enemies'
        db.delete_column('userprofs_userprofile', 'defeated_enemies')
    ...
    models = {
        ...
        'userprofs.userprofile': {
            ...
            'defeated_enemies': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '256'}),
