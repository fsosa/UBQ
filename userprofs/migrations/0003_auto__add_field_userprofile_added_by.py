...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('userprofs_userprofile', 'added_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='userprof_added_by', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.added_by'
        db.delete_column('userprofs_userprofile', 'added_by_id')
    ...
    models = {
        ...
        'userprofs.userprofile': {
            ...
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'userprof_added_by'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
