...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field accessible_by on 'UserProfile'
        db.create_table('userprofs_userprofile_accessible_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['userprofs.userprofile'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('userprofs_userprofile_accessible_by', ['userprofile_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field accessible_by on 'UserProfile'
        db.delete_table('userprofs_userprofile_accessible_by')
