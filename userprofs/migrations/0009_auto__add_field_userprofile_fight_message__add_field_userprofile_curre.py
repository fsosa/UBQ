...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.fight_message'
        db.add_column('userprofs_userprofile', 'fight_message', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'UserProfile.current_enemy'
        db.add_column('userprofs_userprofile', 'current_enemy', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['beasties_app.Enemy']), keep_default=False)

        # Changing field 'UserProfile.is_teacher'
        db.alter_column('userprofs_userprofile', 'is_teacher', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserProfile.defeated_enemies'
        db.alter_column('userprofs_userprofile', 'defeated_enemies', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.fight_message'
        db.delete_column('userprofs_userprofile', 'fight_message')

        # Deleting field 'UserProfile.current_enemy'
        db.delete_column('userprofs_userprofile', 'current_enemy_id')

        # Changing field 'UserProfile.is_teacher'
        db.alter_column('userprofs_userprofile', 'is_teacher', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserProfile.defeated_enemies'
        db.alter_column('userprofs_userprofile', 'defeated_enemies', self.gf('django.db.models.fields.CharField')(max_length=256))
