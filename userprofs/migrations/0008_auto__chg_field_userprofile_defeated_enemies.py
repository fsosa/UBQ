...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.defeated_enemies'
        db.alter_column('userprofs_userprofile', 'defeated_enemies', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256))
    ...
    models = {
        ...
        'userprofs.userprofile': {
            ...
            'defeated_enemies': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
